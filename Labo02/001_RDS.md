...
```sql
[INPUT]
//help : mysql -h dbi-devopsteam09.cshki92s4w5p.eu-west-3.rds.amazonaws.com -u admin -p
mariadb -u admin -h dbi-devopsteam09.cshki92s4w5p.eu-west-3.rds.amazonaws.com -p
[OUTPUT]
```
