...
```
![price comparaison](img/PRICE_COMPARAISON.png)
As we can see there is a huge difference between the RDS instance and the EC2 almost 10 times more expensive. This could be explain by the fact that a RDS instance 
```
